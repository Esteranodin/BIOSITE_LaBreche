...
export function ArticlePlaceholder({
  ...
  return (
    <div className="w-full h-full relative rounded-2xl overflow-hidden">
      ...
      <h3
        className="absolute inset-0 flex items-center justify-center font-bold text-center px-4 transition-opacity duration-400 group-hover:opacity-0 text-[var(--color-text-primary)] z-40"
